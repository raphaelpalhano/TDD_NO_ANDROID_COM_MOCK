...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        atualizadorDeLeiloes.buscaLeiloes(adapter, client, new AtualizadorDeLeiloes.ErrorCarregaLeiloesListener() {
            @Override
            public void erroAoCarregar(String mensagem) {
                mensagemDeFalhaQuandoNaoCarregarOLeilao();
            }
        });
    }


    public void mensagemDeFalhaQuandoNaoCarregarOLeilao() {
        Toast.makeText(this,
